...
function optionsframework_options() {
        ...
        // Color Array
        $color_array = array(
                '#cc0000' => $imagepath . 'wolfpackred.png',
		'#990000' => $imagepath . 'reynoldsred.png',
		'#D14905' => $imagepath . 'pyromanflame.png',
		'#FDD726' => $imagepath . 'huntyellow.png',
		'#7D8C1F' => $imagepath . 'genomicgreen.png',
		'#427E93' => $imagepath . 'innovationblue.png',
		'#4156A1' => $imagepath . 'bioindigo.png',
		'#F2F2F2' => $imagepath . '10pgray.png',
		'#CCCCCC' => $imagepath . '25pgray.png',
		'#666666' => $imagepath . '60pgray.png',
		'#333333' => $imagepath . '90pgray.png',
		'#000000' => $imagepath . 'wolfpackblack.png',
		'#ffffff' => $imagepath . 'wolfpackwhite.png'
        );

        // B/W Color Array
        $bw_color_array = array(
                '#000000' => $imagepath . 'wolfpackblack.png',
		'#ffffff' => $imagepath . 'wolfpackwhite.png'
        );

	// G/B/W Color Array
        $gbw_color_array = array(
		'#F2F2F2' => $imagepath . '10pgray.png',
		'#CCCCCC' => $imagepath . '25pgray.png',
		'#666666' => $imagepath . '60pgray.png',
		'#333333' => $imagepath . '90pgray.png',
     ...
     // Pull all the categories into an array
		...
		$options[] = array( 'name' => __('Blog Post Settings', 'unite'),
							'id' => 'blog_settings',
							'std' => '1',
							'type' => 'select',
							'options' => $blog_layout);
		...
		$options[] = array( "name" => __('Website Layout Options', 'unite'),
							"desc" => __('Choose between Left and Right sidebar options to be used as default. Individual pages may use templates that override this default.', 'unite'),
							"id" => "site_layout",
							"std" => "pull-left",
							"type" => "select",
							"class" => "mini",
		...
		$options[] = array( 'name' => __('Element color', 'unite'),
							'desc' => __('NCSU Color Palette. See <a href="http://brand.ncsu.edu/color/" target="_blank">http://brand.ncsu.edu/color/</a> for more details. Wolfpack Red is used by default.', 'unite'),
							'id' => 'element_color',
							'std' => "#cc0000",
							'type' => "images",
							'options' => $color_array
		...
		$options[] = array( 'name' => __('Element color on hover', 'unite'),
							'desc' => __('NCSU Color Palette. See <a href="http://brand.ncsu.edu/color/" target="_blank">http://brand.ncsu.edu/color/</a> for more details. Reynolds Red is used by default.', 'unite'),
		...
		$options[] = array(
				'name' => __('NCSU Brick', 'unite'),
				'desc' => __('Required element. See <a href="http://brand.ncsu.edu/logo/" target="_blank">http://brand.ncsu.edu/logo/</a> for more details. The 2x1 brick is used by default.', 'unite'),
				'id' => "ncsu_logo",
				'std' => "ncstate-brick-2x1-red.png",
				'type' => "images",
				'options' => array(
         				'ncstate-brick-2x1-red.png' => $imagepath . '2x1small.png',
					'ncstate-brick-2x2-red.png' => $imagepath . '2x2small.png'
				        )
			);
		...
		$options[] = array( 'name' => __('Top nav link color', 'unite'),
							'desc' => __('White is used by default. Please use the color that provides the most contrast with the navbar background.', 'unite'),
							'id' => 'top_nav_link_color',
							'std' => '#ffffff',
							'type' => 'images',
							'options' => $bw_color_array
			);
		...
		$options[] = array( 'name' => __('Top nav dropdown link color', 'unite'),
							'desc' => __('White is used by default. Please use the color that provides the most contrast with the nav dropdown background.', 'unite'),
		...
		$options[] = array( 'name' => __('Footer Text Color', 'unite'),
							'desc' => __('Default is 10% Gray. Choose a color that contrasts well with the background.', 'unite'),
							'id' => 'footer_text_color',
							'std' => '#f2f2f2',
							'type' => 'images',
							'options' => $gbw_color_array
			);

		$options[] = array( 'name' => __('Footer Link Color', 'unite'),
							'desc' => __('Default is White. Choose a color that contrasts well with the background and is distinct from the text color.', 'unite'),
